...
| [usePlatformBrightness](https://pub.dartlang.org/documentation/flutter_hooks/latest/flutter_hooks/usePlatformBrightness.html)                 | Returns current platform `Brightness` and rebuilds the widget on change.   |
